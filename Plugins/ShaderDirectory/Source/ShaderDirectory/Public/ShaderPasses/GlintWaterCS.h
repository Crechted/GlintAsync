...
BEGIN_SHADER_PARAMETER_STRUCT(FGlintTextureComputeParams,)
    ...
    //SHADER_PARAMETER_TEXTURE(Texture2DArray, View_GlintTexture)
    SHADER_PARAMETER_TEXTURE(Texture2D<float4>, NormalTexture1)
    SHADER_PARAMETER_TEXTURE(Texture2D<float4>, Custom1Texture)
    SHADER_PARAMETER_TEXTURE(Texture2D<float4>, Custom2Texture)
